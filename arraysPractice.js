...
function removeItem(groceryList, item) {
  //Test driver is passing in an undefined array
...
var user2 = {
    ...
    password: 'iConquerJavaScript',
    username: 'noMoarElba'
};
var user3 = {
    name: 'Publius Cornelius Scipio Africanus',
    email: 'BaneOfHannibal@gmail.com',
    password: 'c4rth4g3Burns',
    username: 'BaneOfHannibal'
};
